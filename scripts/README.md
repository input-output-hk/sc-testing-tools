...
scripts/list-test-suites.sh

# pretty-print with jq
scripts/list-test-suites.sh | jq .

# scan another repo
scripts/list-test-suites.sh /path/to/some/haskell/repo

# legacy tab-separated output
scripts/list-test-suites.sh --tsv
```
...
```bash
bash scripts/test-list-test-suites.sh
```
...
See the [project README](../README.md) for the wider `sc-testing-tools` libraries.
