...
instance TestingInterface MultisigV3Model where
  ...
  redeemerTagger =
    autoRedeemerTag (Proxy @MultisigV3SpendRedeemer)
      <> autoRedeemerTag (Proxy @ValidationMintRedeemerV3)
...
instance ThreatModelsFor MultisigV3Model where
  ...
  expectedVulnerabilities =
    ...
    , (duplicateListEntryAttack, "CTF exercise: the contract ships with this vulnerability deliberately")
    ]
